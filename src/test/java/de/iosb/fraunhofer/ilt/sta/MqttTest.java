...
//    @Test
    public void subscribeEntityDirect() throws MalformedURLException, MqttException {
        Assert.assertEquals(version + "/Actuators(1)", ActuatorBuilder.builder().service(service).id(new IdLong(1L)).build().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/Datastreams(1)", DatastreamBuilder.builder().service(service).id(new IdLong(1L)).build().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/FeaturesOfInterest(1)", FeatureOfInterestBuilder.builder().service(service).id(new IdLong(1L)).build().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/HistoricalLocations(1)", HistoricalLocationBuilder.builder().service(service).id(new IdLong(1L)).build().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/MultiDatastreams(1)", MultiDatastreamBuilder.builder().service(service).id(new IdLong(1L)).build().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/Observations(1)", ObservationBuilder.builder().service(service).id(new IdLong(1L)).build().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/ObservedProperties(1)", ObservedPropertyBuilder.builder().service(service).id(new IdLong(1L)).build().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/Sensors(1)", SensorBuilder.builder().service(service).id(new IdLong(1L)).build().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/Tasks(1)", TaskBuilder.builder().service(service).id(new IdLong(1L)).build().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/TaskingCapabilities(1)", TaskingCapabilityBuilder.builder().service(service).id(new IdLong(1L)).build().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/Things(1)", ThingBuilder.builder().service(service).id(new IdLong(1L)).build().subscribe(x -> {}).getTopic());
    }
...
//    @Test
    public void subscribeEntityRelative() throws MalformedURLException, MqttException {
        ...
        Assert.assertEquals(version + "/Datastreams(1)/ObservedProperty", datastream.subscribeRelative(x -> {}, EntityType.OBSERVED_PROPERTY).getTopic());
        Assert.assertEquals(version + "/Datastreams(1)/Sensor", datastream.subscribeRelative(x -> {}, EntityType.SENSOR).getTopic());
        Assert.assertEquals(version + "/Datastreams(1)/Thing", datastream.subscribeRelative(x -> {}, EntityType.THING).getTopic());

        HistoricalLocation historicalLocation = HistoricalLocationBuilder.builder().service(service).id(new IdLong(1L)).build();
        Assert.assertEquals(version + "/HistoricalLocations(1)/Thing", historicalLocation.subscribeRelative(x -> {}, EntityType.THING).getTopic());

        MultiDatastream multiDatastream = MultiDatastreamBuilder.builder().service(service).id(new IdLong(1L)).build();
        Assert.assertEquals(version + "/MultiDatastreams(1)/Sensor", multiDatastream.subscribeRelative(x -> {}, EntityType.SENSOR).getTopic());
        Assert.assertEquals(version + "/MultiDatastreams(1)/Thing", multiDatastream.subscribeRelative(x -> {}, EntityType.THING).getTopic());

        Observation observation = ObservationBuilder.builder().service(service).id(new IdLong(1L)).build();
        Assert.assertEquals(version + "/Observations(1)/Datastream", observation.subscribeRelative(x -> {}, EntityType.DATASTREAM).getTopic());
        Assert.assertEquals(version + "/Observations(1)/Datastream/ObservedProperty", observation.subscribeRelative(x -> {}, EntityType.DATASTREAM, EntityType.OBSERVED_PROPERTY).getTopic());
        Assert.assertEquals(version + "/Observations(1)/Datastream/Sensor", observation.subscribeRelative(x -> {}, EntityType.DATASTREAM, EntityType.SENSOR).getTopic());
        Assert.assertEquals(version + "/Observations(1)/Datastream/Thing", observation.subscribeRelative(x -> {}, EntityType.DATASTREAM, EntityType.THING).getTopic());
        Assert.assertEquals(version + "/Observations(1)/FeatureOfInterest", observation.subscribeRelative(x -> {}, EntityType.FEATURE_OF_INTEREST).getTopic());

        Task task = TaskBuilder.builder().service(service).id(new IdLong(1L)).build();
        Assert.assertEquals(version + "/Tasks(1)/TaskingCapability", task.subscribeRelative(x -> {}, EntityType.TASKING_CAPABILITY).getTopic());

        TaskingCapability taskingCapability = TaskingCapabilityBuilder.builder().service(service).id(new IdLong(1L)).build();
        Assert.assertEquals(version + "/TaskingCapabilities(1)/Actuator", taskingCapability.subscribeRelative(x -> {}, EntityType.ACTUATOR).getTopic());
        Assert.assertEquals(version + "/TaskingCapabilities(1)/Thing", taskingCapability.subscribeRelative(x -> {}, EntityType.THING).getTopic());
    }
...
//    @Test
    public void subscribeEntitySetDirect() throws MalformedURLException, MqttException {
        Assert.assertEquals(version + "/Actuators", service.actuators().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/Datastreams", service.datastreams().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/FeaturesOfInterest", service.featuresOfInterest().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/HistoricalLocations", service.historicalLocations().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/MultiDatastreams", service.multiDatastreams().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/Observations", service.observations().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/ObservedProperties", service.observedProperties().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/Sensors", service.sensors().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/Tasks", service.tasks().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/TaskingCapabilities", service.taskingCapabilities().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/Things", service.things().subscribe(x -> {}).getTopic());
    }
...
//    @Test
    public void subscribeEntitySetRelative() throws MalformedURLException, MqttException {
        ...
        Assert.assertEquals(version + "/Actuators(1)/TaskingCapabilities", actuator.taskingCapabilities().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/Actuators(1)/TaskingCapabilities?$select=id,name", actuator.taskingCapabilities().subscribe(x -> {}, EntityProperty.ID, EntityProperty.NAME).getTopic());

        Datastream datastream = DatastreamBuilder.builder().service(service).id(new IdLong(1L)).build();
        Assert.assertEquals(version + "/Datastreams(1)/Observations", datastream.observations().subscribe(x -> {}).getTopic());

        FeatureOfInterest featureOfInterest = FeatureOfInterestBuilder.builder().service(service).id(new IdLong(1L)).build();
        Assert.assertEquals(version + "/FeaturesOfInterest(1)/Observations", featureOfInterest.observations().subscribe(x -> {}).getTopic());

        HistoricalLocation historicalLocation = HistoricalLocationBuilder.builder().service(service).id(new IdLong(1L)).build();
        Assert.assertEquals(version + "/HistoricalLocations(1)/Locations", historicalLocation.locations().subscribe(x -> {}).getTopic());

        MultiDatastream multiDatastream = MultiDatastreamBuilder.builder().service(service).id(new IdLong(1L)).build();
        Assert.assertEquals(version + "/MultiDatastreams(1)/Observations", multiDatastream.observations().subscribe(x -> {}).getTopic());

        ObservedProperty observedProperty = ObservedPropertyBuilder.builder().service(service).id(new IdLong(1L)).build();
        Assert.assertEquals(version + "/ObservedProperties(1)/Datastreams", observedProperty.datastreams().subscribe(x -> {}).getTopic());

        Sensor sensor = SensorBuilder.builder().service(service).id(new IdLong(1L)).build();
        Assert.assertEquals(version + "/Sensors(1)/Datastreams", sensor.datastreams().subscribe(x -> {}).getTopic());

        TaskingCapability taskingCapability = TaskingCapabilityBuilder.builder().service(service).id(new IdLong(1L)).build();
        Assert.assertEquals(version + "/TaskingCapabilities(1)/Tasks", taskingCapability.tasks().subscribe(x -> {}).getTopic());

        Thing thing = ThingBuilder.builder().service(service).id(new IdLong(1L)).build();
        Assert.assertEquals(version + "/Things(1)/Datastreams", thing.datastreams().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/Things(1)/HistoricalLocations", thing.historicalLocations().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/Things(1)/Locations", thing.locations().subscribe(x -> {}).getTopic());
        Assert.assertEquals(version + "/Things(1)/TaskingCapabilities", thing.taskingCapabilities().subscribe(x -> {}).getTopic());
    }
}
